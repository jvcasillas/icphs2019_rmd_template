...
work, her work, their work). Reference as "anonymous" only work that you or the other authors have submitted for publication, but which has not yet been 
published, e.g. [8].
...
contribution. The book editors appear before the book title. The page numbers are at the end.
...
Which means you have access to any objects assigned in the script: 

```{r, 'ex_plot', fig.align='center', fig.width=3, fig.height=2.75} 
cars_plot
```
